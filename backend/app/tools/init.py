...
tools = [add, subtract, multiply, exponentiate, final_answer, 
         ...
         backtest.intra_week_long_and_close, backtest.intra_week_short_and_cover, backtest.analyse_hit_rate, backtest.analyse_completed_trades, backtest.analyse_sharpe_ratio,
         backtest.plot_hit_rate, backtest.plot_portfolio_history]
